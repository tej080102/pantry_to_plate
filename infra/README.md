...
- Vertex AI Gemini used for ingredient perception

## Intended setup flow

1. Create a dedicated GCP project.
2. Enable the required APIs for Cloud Run, Cloud SQL, Cloud Storage, IAM, Secret Manager, and Vertex AI.
...
5. Configure secrets, environment variables, and Vertex AI access for the backend runtime.
...
- Vertex AI service/account provisioning
